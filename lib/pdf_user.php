...
$pdf->Cell (0,5,utf8_decode('Dirección de Tecnologias de la Información y Comunicación'),0,1,'C');
$pdf->Cell (0,5,utf8_decode('Unidad de Infraestructura y Telecomunicaciones'),0,1,'C');

$pdf->Ln();
$pdf->Ln();
$pdf->Cell (0,5,utf8_decode('Copia del Usuario'),0,1,'C');
...
$pdf->Cell (35,45,'Descripcion',1,0,'C',true);
