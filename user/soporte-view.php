<div class="container">
  <div class="row well">
    <div class="col-sm-3">
      <img src="img/01.png" class="img-responsive" alt="Image">
    </div>
    <div class="col-sm-9 lead">
      <h2 class="text-info">Bienvenido al centro de soporte de UNIT</h2>
      <p>Es muy facil de usar, si usted tiene problemas con alguno de nuestros servicios nos puede enviar un nuevo ticket, nosotros lo respondemos y solucionaremos su problema lo mas pronto posible.<br>Si ya nos ha enviado un ticket puede consultar el estado de este mediante su <strong>Ticket ID</strong>.</p>
    </div>
  </div><!--fin row 1-->
    ...
    <div class="col-sm-6">
      <div class="panel panel-info">
        ...
        <div class="panel-body text-center">
          ...
          <p class="text-justify">Si tienes un problema con cualquiera de nuestros servicios reportalo creando un nuevo ticket y te ayudaremos a solucionarlo.Si desea actualizar una peticion ya realizada utiliza el formulario de la derecha <em>Comprobar estado de Ticket</em>, solamente los <strong>usuarios registrados</strong> pueden abrir un nuevo ticket.</p>
