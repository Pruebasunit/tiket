...
?>
        <div class="container">
            ...
            <div class="col-sm-10 lead text-justify">
              ...
              <p>Si su <strong>ticket</strong> no ha sido solucionado, espere pacientemente, estamos trabajando para poder resolver su problema lo mas pronto posible</p>
            </div>
          </div><!--fin row well-->
          <div class="row">
              <div class="col-sm-12">
                      ...
                      <div class="panel-body">
                          <div class="container">
                              <div class="col-sm-12">
                                  <div class="row">
                                      <div class="col-sm-4">
                                          <img class="img-responsive" alt="Image" src="img/01.png">
                                      </div>
                                      <div class="col-sm-8">
                                          <div class="row">
                                              <div class="col-sm-6"><strong>Fecha:</strong> <?php echo $lsT['fecha']; ?></div>
                                              <div class="col-sm-6"><strong>Estatus:</strong> <?php echo $lsT['estado_ticket']; ?></div>
                                          </div>
                                          <br>
                                          <div class="row">
